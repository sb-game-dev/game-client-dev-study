    ...
    SubShader {
        ...
        Pass {
            ...
            PlayerProgram "vp" {
                ...
                SubProgram "d3d11 " {
                    Keywords { "FOG_LINEAR" "INSTANCING_ON" "SECTOR" }
                    "// shader disassembly not supported on DXBC"
                }
                SubProgram "d3d11 " {
                    Keywords { "FOG_LINEAR" "INSTANCING_ON" "SECTOR" }
                ...
                SubProgram "d3d11 " {
                    Keywords { "FOG_EXP" "INSTANCING_ON" "SECTOR" }
                    "// shader disassembly not supported on DXBC"
                }
                SubProgram "d3d11 " {
                    Keywords { "FOG_EXP" "INSTANCING_ON" "SECTOR" }
                ...
                SubProgram "d3d11 " {
                    Keywords { "FOG_EXP2" "INSTANCING_ON" "SECTOR" }
                    "// shader disassembly not supported on DXBC"
                }
                SubProgram "d3d11 " {
                    Keywords { "FOG_EXP2" "INSTANCING_ON" "SECTOR" }
                ...
                SubProgram "d3d11 " {
                    Keywords { "FOG_LINEAR" "INNER_RADIUS" "INSTANCING_ON" }
                    "// shader disassembly not supported on DXBC"
                }
                SubProgram "d3d11 " {
                    Keywords { "FOG_LINEAR" "INNER_RADIUS" "INSTANCING_ON" }
                ...
                SubProgram "d3d11 " {
                    Keywords { "FOG_EXP" "INNER_RADIUS" "INSTANCING_ON" }
                    "// shader disassembly not supported on DXBC"
                }
                SubProgram "d3d11 " {
                    Keywords { "FOG_EXP" "INNER_RADIUS" "INSTANCING_ON" }
                ...
                SubProgram "d3d11 " {
                    Keywords { "FOG_EXP2" "INNER_RADIUS" "INSTANCING_ON" }
                    "// shader disassembly not supported on DXBC"
                }
                SubProgram "d3d11 " {
                    Keywords { "FOG_EXP2" "INNER_RADIUS" "INSTANCING_ON" }
                ...
                SubProgram "d3d11 " {
                    Keywords { "FOG_LINEAR" "INNER_RADIUS" "INSTANCING_ON" "SECTOR" }
                    "// shader disassembly not supported on DXBC"
                }
                SubProgram "d3d11 " {
                    Keywords { "FOG_LINEAR" "INNER_RADIUS" "INSTANCING_ON" "SECTOR" }
                ...
                SubProgram "d3d11 " {
                    Keywords { "FOG_EXP" "INNER_RADIUS" "INSTANCING_ON" "SECTOR" }
                    "// shader disassembly not supported on DXBC"
                }
                SubProgram "d3d11 " {
                    Keywords { "FOG_EXP" "INNER_RADIUS" "INSTANCING_ON" "SECTOR" }
                ...
                SubProgram "d3d11 " {
                    Keywords { "FOG_EXP2" "INNER_RADIUS" "INSTANCING_ON" "SECTOR" }
                    "// shader disassembly not supported on DXBC"
                }
                SubProgram "d3d11 " {
                    Keywords { "FOG_EXP2" "INNER_RADIUS" "INSTANCING_ON" "SECTOR" }
