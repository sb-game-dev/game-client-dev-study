...
//
///////////////////////////////////////////
Shader "CharacterShowBack" {
    Properties {
        _AlphaCutoff ("Alpha Cutoff ", Range(0, 1)) = 0.5
        _EmissionColor ("Emission Color", Color) = (1,1,1,1)
        _Color0 ("Color 0", Color) = (0.3537736,0.7873179,1,0)
        _Power ("Power", Float) = 1
        _Noise ("Noise", 2D) = "white" { }
        _TempratureLerp ("TempratureLerp", Range(0, 1)) = 1
        _HideInThermal ("HideInThermal", Range(0, 1)) = 1
        _NoiseStrength ("NoiseStrength", Range(0, 1)) = 0
        _NoiseTileAndSpeed ("NoiseTileAndSpeed", Vector) = (1,1,1,1)
    ...
    SubShader {
        ...
        Pass {
            Name "GBuffer"
            Tags { "LIGHTMODE" = "UniversalGBuffer" "QUEUE" = "Transparent" "RenderPipeline" = "UniversalPipeline" "RenderType" = "Transparent" }
            Blend SrcAlpha OneMinusSrcAlpha, One OneMinusSrcAlpha
            ZTest GEqual
            GpuProgramID 117518
            PlayerProgram "vp" {
