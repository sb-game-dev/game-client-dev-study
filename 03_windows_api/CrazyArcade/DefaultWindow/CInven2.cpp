...
CInven2* CInven2::m_pInstance = nullptr;

CInven2::CInven2() :m_iGold(50000), m_bDraw(false), m_bButtonCurState(false), m_bButtonPreState(false), m_iPreSlotIndex(-1)
{
...
void CInven2::AddItemToStorage(ITEMTYPE eID)
{
