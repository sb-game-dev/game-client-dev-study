...
bool WavesApp::Init()
{
	...
	mSky = new Sky(md3dDevice, L"../../Assets/Textures/snowcube1024.dds", 5000.0f);

	ID3D11Resource* texResource = nullptr;
	HR(CreateDDSTextureFromFile(md3dDevice, L"../../Assets/Textures/floor.dds", &texResource, &mStoneTexSRV));
	ReleaseCOM(texResource); // view saves reference

	HR(CreateDDSTextureFromFile(md3dDevice, L"../../Assets/Textures/bricks.dds", &texResource, &mBrickTexSRV));
	ReleaseCOM(texResource); // view saves reference

	HR(CreateDDSTextureFromFile(md3dDevice, L"../../Assets/Textures/floor_nmap.dds", &texResource, &mStoneNormalTexSRV));
	ReleaseCOM(texResource); // view saves reference

	HR(CreateDDSTextureFromFile(md3dDevice, L"../../Assets/Textures/bricks_nmap.dds", &texResource, &mBrickNormalTexSRV));
	ReleaseCOM(texResource); // view saves reference

	HR(CreateDDSTextureFromFile(md3dDevice, L"../../Assets/Textures/waves0.dds", &texResource, &mWavesNormalTexSRV0));
	ReleaseCOM(texResource); // view saves reference

	HR(CreateDDSTextureFromFile(md3dDevice, L"../../Assets/Textures/waves1.dds", &texResource, &mWavesNormalTexSRV1));
	ReleaseCOM(texResource); // view saves reference
