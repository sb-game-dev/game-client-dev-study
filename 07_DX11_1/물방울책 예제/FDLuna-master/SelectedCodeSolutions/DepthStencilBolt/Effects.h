...
public:
	...
	void SetAnimArray(ID3D11ShaderResourceView* tex)  	{ AnimArray->SetResource(tex); }
	void SetUseAnim(bool use)							{ UseAnim->SetFloat(use ? 1.f : 0.f); }
	void SetAnimIndex(float index)						{ AnimIndex->SetFloat(index);
	}
	...
	ID3DX11EffectScalarVariable* UseAnim;
	ID3DX11EffectScalarVariable* AnimIndex;

	ID3DX11EffectShaderResourceVariable* DiffuseMap;
	ID3DX11EffectShaderResourceVariable* AnimArray;
};
#pragma endregion
