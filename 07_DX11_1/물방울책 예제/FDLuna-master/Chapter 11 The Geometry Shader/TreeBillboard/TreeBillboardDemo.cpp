...
bool TreeBillboardApp::Init()
{
	...
	HR(CreateDDSTextureFromFile(md3dDevice, L"../../Assets/Textures/WireFence.dds", &texResource, &mBoxMapSRV));
	ReleaseCOM(texResource); // view saves reference

	HR(CreateDDSTextureFromFile(md3dDevice, L"../../Assets/Textures/trees.dds", &texResource, &mTreeTextureMapArraySRV));
	ReleaseCOM(texResource); // view saves reference
