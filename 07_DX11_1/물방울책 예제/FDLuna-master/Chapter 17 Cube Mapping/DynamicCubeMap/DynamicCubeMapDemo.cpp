...
bool DynamicCubeMapApp::Init()
{
	...
	mSky = new Sky(md3dDevice, L"../../Assets/Textures/sunsetcube1024.dds", 5000.0f);

	ID3D11Resource* texResource = nullptr;
	HR(CreateDDSTextureFromFile(md3dDevice, L"../../Assets/Textures/floor.dds", &texResource, &mFloorTexSRV));
	ReleaseCOM(texResource); // view saves reference

	HR(CreateDDSTextureFromFile(md3dDevice, L"../../Assets/Textures/stone.dds", &texResource, &mStoneTexSRV));
	ReleaseCOM(texResource); // view saves reference
