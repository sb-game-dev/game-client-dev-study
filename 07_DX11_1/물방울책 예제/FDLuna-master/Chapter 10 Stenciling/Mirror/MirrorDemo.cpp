...
bool MirrorApp::Init()
{
	...
	HR(CreateDDSTextureFromFile(md3dDevice, L"../../Assets/Textures/checkboard.dds", &texResource, &mFloorDiffuseMapSRV));
	ReleaseCOM(texResource); // view saves reference

	HR(CreateDDSTextureFromFile(md3dDevice, L"../../Assets/Textures/brick01.dds", &texResource, &mWallDiffuseMapSRV));
	ReleaseCOM(texResource); // view saves reference

	HR(CreateDDSTextureFromFile(md3dDevice, L"../../Assets/Textures/ice.dds", &texResource, &mMirrorDiffuseMapSRV));
	ReleaseCOM(texResource); // view saves reference
