...
bool ParticlesApp::Init()
{
	...
	mSky = new Sky(md3dDevice, L"../../Assets/Textures/grasscube1024.dds", 5000.0f);

	Terrain::InitInfo tii;
	tii.HeightMapFilename = L"../../Assets/Textures/terrain.raw";
	tii.LayerMapFilename = L"../../Assets/Textures/layer_map.dds";
	tii.BlendMapFilename = L"../../Assets/Textures/blend.dds";
	...
	HR(CreateDDSTextureFromFile(md3dDevice, L"../../Assets/Textures/flare0.dds", &texResource, &mFlareTexSRV));
	ReleaseCOM(texResource); // view saves reference

	mFire.Init(md3dDevice, Effects::FireFX, mFlareTexSRV, mRandomTexSRV, 500); 
	mFire.SetEmitPos(XMFLOAT3(0.0f, 1.0f, 120.0f));

	HR(CreateDDSTextureFromFile(md3dDevice, L"../../Assets/Textures/raindrop.dds", &texResource, &mRainTexSRV));
	ReleaseCOM(texResource); // view saves reference
