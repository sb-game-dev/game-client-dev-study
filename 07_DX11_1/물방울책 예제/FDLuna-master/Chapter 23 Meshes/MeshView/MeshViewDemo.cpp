...
bool MeshViewApp::Init()
{
	...
	mSky  = new Sky(md3dDevice, L"../../Assets/Textures/desertcube1024.dds", 5000.0f);
	...
	mTreeModel = new BasicModel(md3dDevice, mTexMgr, "../../Assets/Models/tree.m3d", L"../../Assets/Textures/");
	mBaseModel = new BasicModel(md3dDevice, mTexMgr, "../../Assets/Models/base.m3d", L"../../Assets/Textures/");
	mStairsModel = new BasicModel(md3dDevice, mTexMgr, "../../Assets/Models/stairs.m3d", L"../../Assets/Textures/");
	mPillar1Model = new BasicModel(md3dDevice, mTexMgr, "../../Assets/Models/pillar1.m3d", L"../../Assets/Textures/");
	mPillar2Model = new BasicModel(md3dDevice, mTexMgr, "../../Assets/Models/pillar2.m3d", L"../../Assets/Textures/");
	mPillar3Model = new BasicModel(md3dDevice, mTexMgr, "../../Assets/Models/pillar5.m3d", L"../../Assets/Textures/");
	mPillar4Model = new BasicModel(md3dDevice, mTexMgr, "../../Assets/Models/pillar6.m3d", L"../../Assets/Textures/");
	mRockModel = new BasicModel(md3dDevice, mTexMgr, "../../Assets/Models/rock.m3d", L"../../Assets/Textures/");
