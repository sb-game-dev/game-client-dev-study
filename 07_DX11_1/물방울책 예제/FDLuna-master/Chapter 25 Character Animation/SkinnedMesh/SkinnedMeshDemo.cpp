...
bool SkinnedMeshApp::Init()
{
	...
	mStoneTexSRV = mTexMgr.CreateTexture(L"../../Assets/Textures/floor.dds");
	mBrickTexSRV = mTexMgr.CreateTexture(L"../../Assets/Textures/bricks.dds");
	mStoneNormalTexSRV = mTexMgr.CreateTexture(L"../../Assets/Textures/floor_nmap.dds");
	mBrickNormalTexSRV = mTexMgr.CreateTexture(L"../../Assets/Textures/bricks_nmap.dds");

	BuildShapeGeometryBuffers();
	BuildSkullGeometryBuffers();
	BuildScreenQuadGeometryBuffers();

	mCharacterModel = new SkinnedModel(md3dDevice, mTexMgr, "../../Assets/Models/soldier.m3d", L"../../Assets/Textures/");
