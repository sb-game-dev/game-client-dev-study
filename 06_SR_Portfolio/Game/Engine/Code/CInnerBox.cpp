...
CInnerBox::CInnerBox(const CInnerBox& rhs) : CVIBuffer(rhs)
{
}
...
HRESULT CInnerBox::Ready_Buffer()
{
...
CInnerBox* CInnerBox::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CInnerBox* pInnerBox = new CInnerBox(pGraphicDev);
...
CComponent* CInnerBox::Clone()
{
	CComponent* pComp = new CInnerBox(*this);
