...
class CEmp_Band : public CGameObject
{
private:
	explicit CEmp_Band(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CEmp_Band() override;
...
public:
	static CEmp_Band* Create(LPDIRECT3DDEVICE9 pGraphicDev);
