#include "CCylinderTex.h"

CCylinderTex::CCylinderTex()
{
}

CCylinderTex::CCylinderTex(LPDIRECT3DDEVICE9 pGraphicDev)
	:CVIBuffer(pGraphicDev)
{
}

CCylinderTex::CCylinderTex(const CCylinderTex& rhs)
	:CVIBuffer(rhs)
{
}
...
HRESULT	CCylinderTex::Ready_Buffer()
{
	...
	pVertex[0].vPosition = { 0.f, 4.f, 0.f };
	...
	pVertex[4].vPosition = { -1.f, 0.f, -1.f };
...
CCylinderTex* CCylinderTex::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CCylinderTex* pPyramidCol = new CCylinderTex(pGraphicDev);
