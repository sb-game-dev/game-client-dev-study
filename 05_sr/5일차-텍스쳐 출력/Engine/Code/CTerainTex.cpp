...
int CTerainTex::GetHeightmapEntry(int row, int col)
{
	return m_vHeightmap[row * VTXCNTX + col];
}

void CTerainTex::SetHeightmapEntry(int row, int col, int value)
{
...
bool CTerainTex::ReadBmp(const char* filename)
{
...
bool CTerainTex::Ready_HeightMap(const wstring& pFilePath)
{
